...
>(
  ...
  // 新增验证码
  return axios.request({
    url: `https://test/api/verifications`,
    method: "post",
    data: params,
    ...options,
  })
...
>(
  ...
  // 获取行政区域（树形）
  return axios.request({
    url: `https://test/api/regions?_as_tree`,
    method: "get",
    params: params,
    ...options,
  })
...
>(
  ...
  // 新增卡片状态？
  return axios.request({
    url: `https://test/api/cards/${CardCode}/states`,
    method: "post",
    data: params,
    ...options,
  })
...
>(
  ...
  // 获取用户订单列表（分页）
  return axios.request({
    url: `https://test/api/orders?_as_page`,
    method: "get",
    params: params,
    ...options,
  })
...
>(
  ...
  // 审核卡片
  return axios.request({
    url: `https://test/api/admin/cards/${CardId}/states/{}`,
    method: "post",
    data: params,
    ...options,
  })
...
>(
  ...
  // 获取卡片（分页）
  return axios.request({
    url: `https://test/api/admin/cards?_as_page`,
    method: "get",
    params: params,
    ...options,
  })
...
>(
  ...
  // 获取订单列表（分页）
  return axios.request({
    url: `https://test/api/admin/orders?_as_page`,
    method: "get",
    params: params,
    ...options,
  })
...
>(
  ...
  // 导出卡片审核
  return axios.request({
    url: `https://test/api/admin/export-card`,
    method: "get",
    params: params,
    ...options,
  })
...
>(
  ...
  // 导出发货订单
  return axios.request({
    url: `https://test/api/admin/export-order`,
    method: "get",
    params: params,
    ...options,
  })
...
>(
  ...
  // 发货
  return axios.request({
    url: `https://test/api/admin/orders/${OrderId}/send-out`,
    method: "post",
    data: params,
    ...options,
  })
